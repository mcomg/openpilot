...
DAYS_NO_CONNECTIVITY_MAX = 365  # do not allow to engage after a year without internet
DAYS_NO_CONNECTIVITY_PROMPT = 360  # send an offroad prompt after 360 days with no internet
